...
const Input = ({placeholder, name ,value, type, handleChange}) => (
  <input type={type} step="0.0001" placeholder={placeholder} name={name} value={value} 
...
const Welcome = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col justify-between items-start md:p-20 py-20 px-4 ">
